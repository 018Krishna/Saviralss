...
import ProductForm from "/src/pages/ProductForm"; // Import the ProductForm component
    ...
    <div>
      ...
      <div>
        ...
        <div className="h-[150px] flex justify-center items-center mt-40">
          ...
          marginLeft: '17px'  // Shifts the text to the right
        }}>
        Admin Panel
      </h3>
    </div>
      ...
      <button
        ...
        className="w-[20%] flex justify-center mb-4 py-2 bg-[#0bb931] text-white rounded-md hover:bg-[#421d11]"
      >
            ...
            return (
              ...
              >
                <div className="relative w-full pb-[55%]">
                  {/* Display main image */}
                  <img
                    src={`${backend}/path-to-images/${item.Image}`} alt={item.name} 
// Base64 image
